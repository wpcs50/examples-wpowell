...
## Checking model reliabilty and accuracy
...
Redo the above analysis. Your regression results are likely to slightly different than the above because you'll be using a different random number seed.
